...
pub fn build(b: *std.Build) !void {
    ...
    gmp.addCSourceFiles(.{
        ...
        .files = &.{
            ...
            "neg.c",         "abs.c",          "iset.c",
            "iset_ui.c",     "iset_si.c",      "iset_d.c",
            "iset_str.c",    "cdiv_q.c",       "cdiv_r.c",
            "cdiv_qr.c",     "cdiv_q_ui.c",    "cdiv_r_ui.c",
            "cdiv_qr_ui.c",  "cdiv_ui.c",      "fdiv_q.c",
            "fdiv_r.c",      "fdiv_qr.c",      "fdiv_q_ui.c",
            "fdiv_r_ui.c",   "fdiv_qr_ui.c",   "fdiv_ui.c",
            "tdiv_q.c",      "tdiv_r.c",       "tdiv_qr.c",
            "tdiv_q_ui.c",   "tdiv_r_ui.c",    "tdiv_qr_ui.c",
            "tdiv_ui.c",     "cfdiv_q_2exp.c", "cfdiv_r_2exp.c",
            "tdiv_q_2exp.c", "tdiv_r_2exp.c",  "mod.c",
